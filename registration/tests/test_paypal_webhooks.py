...
class TestMalformedPaypalRefundWebhooks(TestCase):
    ...
    def test_paypal_webhook_invalid_signature(self, mock_build_absolute_uri):
    ...
    @patch("django.http.request.HttpRequest.build_absolute_uri")
    def test_paypal_webhook_invalid_json(
    ...
    @override_settings(SQUARE_WEBHOOK_SIGNATURE_KEY=SIGNATURE_KEY)
    @patch("django.http.request.HttpRequest.build_absolute_uri")
    def test_paypal_webhook_idempotency(self, mock_build_absolute_uri):
...
class TestPaypalRefundWebhooks(TestCase):
    ...
    @override_settings(SQUARE_WEBHOOK_SIGNATURE_KEY=SIGNATURE_KEY)
    @patch("django.http.request.HttpRequest.build_absolute_uri")
    def test_paypal_webhook(self, mock_build_absolute_uri):
        mock_build_absolute_uri.return_value = self.NOTIFICATION_URL
