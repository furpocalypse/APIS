# Generated by Django 5.2 on 2025-05-04 01:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_age', models.IntegerField(blank=True, help_text='Leave blank for no limit', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('optionExtraType', models.CharField(blank=True, choices=[('int', 'Quantity'), ('bool', 'Yes/No'), ('ShirtSizes', 'Shirt Size'), ('string', 'String')], max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.attendee')),
                ('holdType', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.holdtype')),
            ],
        ),
        migrations.CreateModel(
            name='Dealer',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('websiteUrl', models.CharField(blank=True, help_text="URL to the homepage for the convention's primary website.", max_length=500, verbose_name='Website URL')),
                ('donations', models.DecimalField(decimal_places=2, default=0, help_text='External donations to add to metrics ', max_digits=12)),
                ...
                ('assistantDiscount', models.ForeignKey(blank=True, help_text='Apply a discount for any dealer assistant registrations', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='assistantEvent', to='registration.discount', verbose_name='Dealer Assistant Discount')),
                ('charity', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.charity')),
                ('dealerDiscount', models.ForeignKey(blank=True, help_text='Apply a discount for any dealer registrations', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dealerEvent', to='registration.discount', verbose_name='Dealer Discount')),
                ('defaultBadgeTemplate', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.badgetemplate', verbose_name='Badge Template')),
                ('newStaffDiscount', models.ForeignKey(blank=True, help_text='Apply a discount for new staff registrations', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='newStaffEvent', to='registration.discount', verbose_name='New Staff Discount')),
                ('staffDiscount', models.ForeignKey(blank=True, help_text='Apply a discount for any staff registrations', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='staffEvent', to='registration.discount', verbose_name='Staff Discount')),
                ('venue', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.venue')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('webview', models.CharField(blank=True, default='https://www.example.com/code-of-conduct-embed/', max_length=500, null=True, verbose_name='Web view URL')),
                ('payment_type', models.CharField(blank=True, choices=[('mqtt-app', 'iPad'), ('square-terminal', 'Square Terminal')], max_length=20, null=True)),
                ('print_via_mqtt', models.ForeignKey(blank=True, help_text='Which terminal to use for printing via MQTT, if it should be used at this terminal.', null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.firebase', verbose_name='Print via MQTT')),
                ('square_terminal_id', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.squaredevice', verbose_name='Square Terminal')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('position', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='firebase_cashdrawer', to='registration.firebase')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('priceLevel', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.pricelevel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('orderItem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registration.orderitem')),
                ('option', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registration.priceleveloption')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notes', models.TextField(blank=True)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='registration.event')),
                ('priceLevel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='registration.pricelevel')),
            ],
            options={
