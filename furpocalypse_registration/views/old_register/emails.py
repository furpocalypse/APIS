...
# Related files: templates/furpocalypse_registration/emails/ (email templates), models.py (Order.apiData)
...
def send_registration_email(order, email, send_vip=True):
    ...
    for oi in order_items:
        ...
        if oi.badge.attendee.email == email:
            ...
            # References:
            # - templates/furpocalypse_registration/emails/registration-payment.txt/html
...
def send_chargeback_notice_email(order):
    ...
    # - templates/furpocalypse_registration/emails/chargeback-notice.txt/html
